...
public class UserRepositoryImpl extends BaseRepository implements UserRepository {
  ...
  @Autowired TokenUpdatePasswordEntityRepository tokenUpdatePasswordEntityRepository;

  @Autowired private UserRepositoryMapper userRepositoryMapper;

  @Autowired private TokenValidateUserEntityRepository tokenValidateUserEntityRepository;
  ...
  public User findUserByEmailNoException(String email) {
    return userRepositoryMapper.userEntityToUser(
        userEntityRepository.findUserByEmail(email).orElse(null));
  }
}
