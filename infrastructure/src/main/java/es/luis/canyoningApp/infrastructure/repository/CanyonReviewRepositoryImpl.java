...
public class CanyonReviewRepositoryImpl implements CanyonReviewRepository {
  ...
  @Autowired private ReviewRepositoryMapper reviewRepositoryMapper;

  @Autowired private UserRepositoryMapper userRepositoryMapper;

  @Autowired CanyonReviewEntityRepository canyonReviewEntityRepository;

  @Autowired CanyonReviewUserEntityRepository canyonReviewUserEntityRepository;
