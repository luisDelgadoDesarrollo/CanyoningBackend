...
import es.luis.canyoningApp.application.rest.api.ReviewApi;
...
public class ReviewController extends BaseController implements ReviewApi {
    ...
    @Autowired
    private CanyonReviewService canyonReviewService;

    @Autowired
    private CanyonReviewControllerMapper canyonReviewControllerMapper;
