...
public class UserServiceImpl extends BaseService implements UserService {
    ...
    public User createUser(User user) {
        ...
        User userByEmailNoException =
                getUserByEmailNoException(user.getEmail().toLowerCase(Locale.ROOT));
    ...
    @Override
    public User getUserByEmailNoException(String email) {
        return userRepository.findUserByEmailNoException(email);
    }
